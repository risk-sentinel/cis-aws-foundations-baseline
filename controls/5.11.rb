...
control 'C-5.11' do
  ...
  desc  'fix', "
    ...
    1. Create a metric filter based on the provided filter pattern that checks for NACL changes and uses the ` ` taken from audit step 1:
  ...
  tag nist:                  ['IA-2 (2)', 'AU-3 a', 'AU-3 d', 'SC-28']
  tag ksi:                   ['KSI-IAM-APM', 'KSI-MLA-OSM', 'KSI-SVC-SIN']
  tag nist_r4:               ['AU-3', 'IA-2 (2)', 'SC-28']
  tag cci:                   ['CCI-000766', 'CCI-000130', 'CCI-000133', 'CCI-001199']
  tag cis_number:            '5.11'
  tag cis_rid:               '5.11'
  ...
  pattern = %q{{ ($.eventName = CreateNetworkAcl) || ($.eventName = CreateNetworkAclEntry) || ($.eventName = DeleteNetworkAcl) || ($.eventName = DeleteNetworkAclEntry) || ($.eventName = ReplaceNetworkAclEntry) || ($.eventName = ReplaceNetworkAclAssociation) }}
