...
control 'C-5.14' do
  ...
  desc  'fix', "
    ...
    1. Create a metric filter based on the provided filter pattern that checks for VPC changes and uses the ` ` taken from audit step 1:
  ...
  tag nist:                  ['AC-2 a', 'IA-2 (2)', 'AU-3 a', 'AU-3 d']
  tag ksi:                   ['KSI-IAM-APM', 'KSI-IAM-JIT', 'KSI-IAM-SNU', 'KSI-IAM-SUS', 'KSI-MLA-OSM']
  tag nist_r4:               ['AC-2 a', 'AU-3', 'IA-2 (2)']
  tag cci:                   ['CCI-002110', 'CCI-000766', 'CCI-000130', 'CCI-000133']
  tag cis_number:            '5.14'
  tag cis_rid:               '5.14'
  ...
  pattern = %q{{ ($.eventName = CreateVpc) || ($.eventName = DeleteVpc) || ($.eventName = ModifyVpcAttribute) || ($.eventName = AcceptVpcPeeringConnection) || ($.eventName = CreateVpcPeeringConnection) || ($.eventName = DeleteVpcPeeringConnection) || ($.eventName = RejectVpcPeeringConnection) || ($.eventName = AttachClassicLinkVpc) || ($.eventName = DetachClassicLinkVpc) || ($.eventName = DisableVpcClassicLink) || ($.eventName = EnableVpcClassicLink) }}
