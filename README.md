...
curl -LO https://github.com/risk-sentinel/cis-aws-foundations-baseline/releases/download/$VERSION/cis-aws-foundations-v7.0.0-$VERSION.tar.gz

# then, on the isolated side
mkdir -p cis-aws-foundations-v7.0.0 && tar xzf cis-aws-foundations-v7.0.0-$VERSION.tar.gz -C cis-aws-foundations-v7.0.0
cd cis-aws-foundations-v7.0.0
...
```yaml
uses: risk-sentinel/cis-aws-foundations-baseline/.github/workflows/exec-evidence.yml@<version>
with:
  profile_source: archive
  archive_path: ./cis-aws-foundations-v7.0.0-<version>.tar.gz
```
...
```yaml
include:
  - project: <your-org>/cis-aws-foundations-baseline
    ref: <version>
